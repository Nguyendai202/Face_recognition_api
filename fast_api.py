...
from facerecognition.face_recongition import model_recognition_restore_from_pb
import tensorflow
import uvicorn
from fastapi.responses import StreamingResponse
import asyncio
import io
from utils.process_realtime import video_init,get_image_paths_recursive
import uuid
from definitions import MAX_FPS,processed_videos_dir,pb_path,node_dict,face_mask_model_path,margin,ref_dir,img_format,id2class,batch_size,threshold
from numba import njit,prange
from utils.processing_api import merge_images
...
sess, tf_dict = model_recognition_restore_from_pb(pb_path, node_dict, GPU_ratio=None)
...
def process_video_api(name_video, ref_dir, video_path, resolution="480", to_write=True, save_dir=None):
    ...
    batch_size = 32
    threshold = 0.7  # 0.8
    cap, height, width, writer = video_init(name_video=name_video,
